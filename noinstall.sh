...
mkdir $license
cd $license
wget --no-check-certificate https://github.com/tokumeikoi/aurora/releases/latest/download/aurora
wget --no-check-certificate https://github.com/v2ray/v2ray-core/releases/latest/download/v2ray-linux-64.zip
